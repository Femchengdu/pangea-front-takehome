  ...
  return (
    <div id="navbar">
      <div className="navbar-inner-container">
        ...
        <a href="http://luminskin.com/" className="logo-link">
        ...
        <a href="http://luminskin.com/">Shop</a>
        <a href="http://luminskin.com/">Learn</a>
      </div>
      <div className="navbar-inner-container">
        <a href="http://luminskin.com/">Account</a>
        <a
          id="cart-icon"
          className="cart-img-container"
          href="http://luminskin.com/"
        >
          <img
